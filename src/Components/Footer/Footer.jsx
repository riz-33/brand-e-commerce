...
import Arrow from "../../assets/Layout/Form/input-group/Icon/control/Vector2.png";
    ...
    <section className="footer-section">
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-column">
            <p className="footer-title">For Users</p>
          ...
          <div className="footer-column">
            <p className="footer-title">Get App</p>
      ...
      <div className="footer-divider">
        <div>
          <p className="footer-credit">© 2023 Ecommerce.</p>
        </div>
